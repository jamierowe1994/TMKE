...
const STEPS = [
  ...
  {
    path: '/account', target: 'a[href="/editor"]', placement: 'bottom',
    eyebrow: 'The Studio',
  ...
  {
    path: '/account', target: 'a[href="/profile"]', placement: 'bottom',
    eyebrow: 'Brand kit',
  ...
  // ---- Studio ----
  {
    path: '/editor', target: '.ed-rail', placement: 'right', padding: 10,
    eyebrow: 'The Studio',
  ...
  {
    path: '/editor', target: '[data-tool="brand"]', placement: 'right', padding: 8,
    eyebrow: 'Brand',
  ...
  {
    path: '/editor', target: '#ed-stage', placement: 'left', padding: 0,
    eyebrow: 'The canvas',
  ...
  {
    path: '/editor', target: '.ed-topbar-right', placement: 'bottom', padding: 8,
  ...
  {
    path: '/editor', target: '#ed-download', placement: 'bottom', padding: 8,
    eyebrow: 'Export',
  ...
  // ---- Brand kit ----
  {
    path: '/profile', target: '#colour-grid', placement: 'top', padding: 12,
  ...
  {
    path: '/profile', target: '#logo-drop', placement: 'top', padding: 12,
  ...
  {
    path: '/profile', target: 'button[type="submit"]', placement: 'top', padding: 10,
    eyebrow: 'Brand kit',
  ...
  {
    path: '/profile', target: null, placement: 'center',
...
function injectStyles() {
  ...
  .tmke-tour-ring {
    ...
    outline: 2px solid var(--english-violet, #474254); outline-offset: 0;
    box-shadow: 0 0 0 1px rgba(189,179,185,0.6) inset, 0 0 0 6px rgba(71,66,84,0.18);
    transition: top .36s cubic-bezier(.4,.7,.2,1), left .36s cubic-bezier(.4,.7,.2,1),
                width .36s cubic-bezier(.4,.7,.2,1), height .36s cubic-bezier(.4,.7,.2,1);
  }
  ...
  .tmke-tour-card {
    ...
    border: 1px solid rgba(71,66,84,0.18); border-radius: 6px;
  ...
  .tmke-tour-eyebrow {
    ...
    color: var(--english-violet, #474254); margin: 0 0 12px;
  }
  .tmke-tour-title {
  ...
  .tmke-tour-title em { font-style: italic; color: var(--english-violet, #474254); }
  .tmke-tour-body {
  ...
  .tmke-tour-skip:hover { color: var(--english-violet, #474254); }
  .tmke-tour-back {
  ...
  .tmke-tour-next {
    ...
    background: var(--english-violet, #474254); color: #fff;
