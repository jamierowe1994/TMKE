...
export const templates = [
  ...
  },
  {
    ...
    name: "Parade",
    category: "Everyday",
    tagline: "Clean, search-led, friendly",
    summary:
      "A polished everyday agency homepage. Big sans-serif headline, embedded search/filter bar, a fast listings grid, and a credible agent profile card.",
    audience: "High-street agents — sales & lettings",
    thumbnail: UNSPLASH("1496564203457-11bb12075d90", 1200, 900),
    accent: "#222222",
    features: [
      "Search-tab hero",
      "Listings grid with pricing",
      "Agent profile card",
      "Buy / Rent / New homes tabs",
    ],
    status: "ready",
  },
];
