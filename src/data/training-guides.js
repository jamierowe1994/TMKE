...
// A picture of the place being described. scripts/hub-course-shots.mjs makes
// them: each area of the hub photographed and set inside a browser window on
// the wine, all of them identical in treatment. A name with no file behind it
// shows a tinted panel rather than a broken image.
const shot = (name, caption) => `<figure class="gr-shot" style="background-image:url(/images/learn/hub/${name}.jpg)"><figcaption>${caption}</figcaption></figure>`;
  ...
  guide({
    ...
    lessons: [
      { title: "The Hub at a Glance", walk: "hub-tour", video_url: "",
        body_html:
          shot("dashboard", "Your Dashboard: the week ahead, and what needs a look") +
      ...
      { title: "What's Where",
        body_html:
          ...
          shot("shop", "The bar along the top is the whole hub: Dashboard, Studio, Planner, Orders, Bookings, Your SMM and Shop") +
          pillars([
      ...
      { title: "Where to Go First",
        body_html:
          ...
          shot("brand-kit", "First stop: your Brand Kit") +
          go([
  ...
  guide({
    ...
    lessons: [
      { title: "Why It Matters", walk: "brand-kit", video_url: "",
        body_html:
          shot("brand-kit", "The Brand Kit: your details on the left, your colours on the right") +
  ...
  guide({
    ...
    lessons: [
      { title: "The Studio Page", walk: "studio-first-design", video_url: "",
        body_html:
          shot("studio", "The Studio: your packs across the top, your saved designs underneath") +
  ...
  guide({
    ...
    lessons: [
      { title: "The Planner", walk: "planner", video_url: "",
        body_html:
          shot("planner", "The Planner: the month, your posts, and the dates worth marking") +
