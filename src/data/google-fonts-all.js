// Every family Google Fonts serves, taken from their own catalogue
// (fonts.google.com/metadata/fonts) on 22 Sep 2026: 1946 of them.
//
// The picker used to offer a hand-picked 197, which is fine until somebody
// wants the 198th — Bricolage Grotesque, say — and the only way to get it was
// to download 105 files and upload them as a custom font, for a face Google
// was already serving for free.
//
// Vendored rather than fetched at runtime: the list changes slowly, and a
// font picker that needs the network to show its options is a font picker
// that sometimes shows nothing. Re-run the fetch now and then to refresh it.
